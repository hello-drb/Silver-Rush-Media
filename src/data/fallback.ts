import { Search, Camera, Globe, Users, Sparkles, BarChart3 } from "lucide-react";

export const FALLBACK_SERVICES = [
  {
    title: "Website Design & Build",
    subtitle: "A digital home you're proud to send people to.",
    description: "Most businesses we work with have either outgrown their website or never had one that really reflected what they do. We design and build sites that clearly communicate who you are, work well on every device, and don't need a developer on speed dial to maintain. We think about what your visitors are actually looking for when they land, and we build around that — not around trends or features you'll never use.",
    details: "This might look like: full website builds, landing pages, e-commerce, site restructuring, content direction, analytics and optimization",
    iconName: "Globe",
    id: "service-web",
    color: "bg-sr-rust"
  },
  {
    title: "Visual Identity & Photography",
    subtitle: "Show up like you mean it.",
    description: "Your visual presence should match the level you're operating at. We create photography, brand imagery, and a visual look that feels intentional, elevated, and distinctly yours. We work with a trusted team of stylists, designers, and creative collaborators to develop the full picture — not just the photos.",
    details: "This might look like: portrait and brand photography, product photography, visual direction, brand video, art direction, styling collaboration",
    iconName: "Camera",
    id: "service-photo",
    color: "bg-sr-sage"
  },
...
export const FALLBACK_PROJECTS = [
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/diduw1fmf/image/upload/v1772604067/freepik__keep-woman-exactly-the-same-but-extend-background-__51580_mixrur.png",
    id: "project-lauretta"
  },
  {
  ...
  },
  {
    ...
    description: "A world-class chamber group of 18 musicians whose visuals didn't match the caliber of their sound. We developed a custom photographic look — elevated, dramatic, built from their existing color palette — that was replicable across current and future members, giving the ensemble a consistent visual language that matched their artistic position.",
    image: "https://res.cloudinary.com/diduw1fmf/image/upload/v1772570214/talea_6portraits_oc1q5o.png",
    id: "project-talea"
  },
  {
    title: "Trilogy Consignment",
